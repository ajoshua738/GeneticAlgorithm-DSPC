...
//    }
//
//    double end_time = clock(); // Stop measuring time
//
...
//    std::cout << std::endl;
//
//    // Print all items and their fitness values
//    std::cout << "\nItems and their fitness values:" << std::endl;
//    for (int i = 0; i < numItems; ++i) {
//        std::cout << "Item " << i << ": Value = " << items[i].value << ", Weight = " << items[i].weight << std::endl;
//    }
//
