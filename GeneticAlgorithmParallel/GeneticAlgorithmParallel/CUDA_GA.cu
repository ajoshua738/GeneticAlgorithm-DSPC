...
//}
//
//__global__ void geneticAlgorithmKernel(char* d_population, char* d_child, size_t itemCount, int* d_totalWeight, int* d_fitness, const Item* d_items, double mutationRate) {
...
//        //calling kernel
//
//        geneticAlgorithmKernel << <1, 128 >> > (d_population, d_child, itemCount, d_totalWeight, d_fitness, d_items, MUTATION_RATE); //perform crossover
//
//
